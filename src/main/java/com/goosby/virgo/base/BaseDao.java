...
import com.goosby.virgo.utils.Page;
...
public abstract class BaseDao<T> {
	...
	public List<T> getTAll() {
		...
		logger.trace(">>>>>>>>>>>>>>: 语句getAll, 获取到{}条纪录", list.size());
		return list;
	}
	...
	public List<T> getTList() {
		...
		logger.trace(">>>>>>>>>>>>>>: 语句getList, 获取到{}条纪录", list.size());
		return list;
	}
	...
	protected List<T> getTList(String listStmtId, Object value) {
		...
		logger.trace(">>>>>>>>>>>>>>: 语句{}, 获取到{}条纪录", listStmtId, list.size());
		return list;
	}
	...
	public int count() {
		...
		logger.trace(">>>>>>>>>>>>>>: 语句count, 共{}条纪录", count);
		return count;
	}
	...
	protected int count(String countStmtId, Map<String, Object> condition) {
		...
		int count = (Integer) this.sqlSessionTemplate.selectOne(this.getMapperNamespace() + countStmtId, condition);
		logger.trace(">>>>>>>>>>>>>>: 语句{}, 共{}条纪录", countStmtId, count);
		return count;
	}
